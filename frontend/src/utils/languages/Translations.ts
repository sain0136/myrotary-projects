...
export const translations: Record<string, Translation> = {
  en: {
    stripeSubscription: {
      ...
      agreeToTerms: `I agree to the <a style="color:blue;" href="subscriptions/terms-of-service" target="_blank">Terms of Service</a> and <a style="color:blue;" href="subscriptions/privacy-policy" target="_blank">Privacy Policy</a>, and acknowledge that my subscription will auto-renew monthly at $50 unless canceled.`,
      privacyPolicyText: `<div style="font-family: Arial, sans-serif; color: #333; padding: 2rem;"> <h1 style="font-weight: bold; color: #0056b3;">Privacy Policy</h1> <p>Effective Date: <strong>December 1, 2024</strong></p> <p>Welcome to Rotary Projects Manager! We value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we handle your data.</p> <h2 style="color: #0056b3;">1. Data Collection</h2> <p>We collect the following information from you:</p> <ul> <li>User ID</li> <li>Club ID</li> </ul> <h2 style="color: #0056b3;">2. Data Usage</h2> <p>We use the collected data to manage your subscription and provide access to our project management tools.</p> <h2 style="color: #0056b3;">3. Data Sharing</h2> <p>We do not share your personal data with third parties, except for Stripe, which handles our payment processing.</p> <h2 style="color: #0056b3;">4. Data Security</h2> <p>We implement basic security measures, including HTTPS and server security, to protect your data. However, please note that no method of transmission over the Internet or method of electronic storage is 100% secure.</p> <h2 style="color: #0056b3;">5. User Rights</h2> <p>You have the right to stop your subscription at any time from your account settings. Stripe will handle the deletion of your subscription data.</p> <h2 style="color: #0056b3;">6. Contact Information</h2> <p>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:jssr26@gmail.com" style="color: #0056b3;">Support</a>.</p> </div>`,
  ...
  fr: {
    stripeSubscription: {
      ...
      agreeToTerms: ` J'accepte les <a style="color:blue;" href='subscriptions/terms-of-service' target='_blank'>Conditions d'utilisation</a> et la <a style="color:blue;" href='subscriptions/privacy-policy' target='_blank'>Politique de confidentialité</a>, et je reconnais que mon abonnement se renouvellera automatiquement chaque mois à 50 $ sauf annulation.`,
      privacyPolicyText: `<div style="font-family: Arial, sans-serif; color: #333; padding: 2rem;"> <h1 style="font-weight: bold; color: #0056b3;">Politique de Confidentialité</h1> <p>Date d'effet : <strong>1 décembre 2024</strong></p> <p>Bienvenue sur Rotary Projects Manager ! Nous accordons une grande importance à votre vie privée et nous nous engageons à protéger vos informations personnelles. Cette Politique de Confidentialité décrit comment nous traitons vos données.</p> <h2 style="color: #0056b3;">1. Collecte de Données</h2> <p>Nous collectons les informations suivantes :</p> <ul> <li>ID Utilisateur</li> <li>ID Club</li> </ul> <h2 style="color: #0056b3;">2. Utilisation des Données</h2> <p>Nous utilisons les données collectées pour gérer votre abonnement et fournir l'accès à nos outils de gestion de projet.</p> <h2 style="color: #0056b3;">3. Partage des Données</h2> <p>Nous ne partageons pas vos données personnelles avec des tiers, à l'exception de Stripe, qui gère notre traitement des paiements.</p> <h2 style="color: #0056b3;">4. Sécurité des Données</h2> <p>Nous mettons en œuvre des mesures de sécurité de base, y compris HTTPS et la sécurité des serveurs, pour protéger vos données. Cependant, veuillez noter qu'aucune méthode de transmission sur Internet ou de stockage électronique n'est 100% sécurisée.</p> <h2 style="color: #0056b3;">5. Droits des Utilisateurs</h2> <p>Vous avez le droit de résilier votre abonnement à tout moment via les paramètres de votre compte. Stripe se chargera de la suppression de vos données d'abonnement.</p> <h2 style="color: #0056b3;">6. Informations de Contact</h2> <p>Si vous avez des questions ou des préoccupations concernant cette Politique de Confidentialité, veuillez nous contacter à <a href="mailto:jssr26@gmail.com" style="color: #0056b3;">Support</a>.</p> </div>`,
      subscriptionEndDate:
        "La souscription de votre club se terminera le: {Date}",
