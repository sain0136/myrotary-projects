...
onMounted(async () => {
  try {
    ...
    handleToast('error', langTranslations.value.toastError, customError.translatedMessage[languagePref.value], '5000')
  }
})
...
<template>
  <div>
    <button @click="toastControler" class=" text-xl text-near-white bg-amber-300 p-4 my-3 rounded-sm"> Yo BRo </button>
    <ul
